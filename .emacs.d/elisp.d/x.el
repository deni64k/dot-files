...
(defun negval/x-dark-theme ()
  ...
  (color-theme-install
   `(negval/x-dark-theme
     ...
     (highlight ((t (:foreground "orange" :underline "orange" :inherit bold))))
     (region    ((t (:background "midnight blue"))))
     (hl-line   ((t (:background "gray5"))))
     (mode-line ((t (:background "gray10" :foreground "gray90"
                     :inverse-video nil :box nil
                     :inherit (sans small)))))
     (mode-line-buffer-id ((t (:foreground "green"))))
     (mode-line-emphasis  ((t (:inherit bold))))
     (mode-line-highlight ((t (:inherit highlight))))
     (mode-line-inactive  ((t (:background "gray7" :foreground "gray90"
                               :inverse-video nil :box nil
     ...
     (which-func ((t (:foreground "lime green" :width condensed :inherit fixed-pitch))))
     (border ((t (:background "DodgerBlue4"))))
     (show-paren-match ((t (:background "gray10"))))
     (show-paren-mismatch ((t (:foreground "Red" :inherit bold))))
     (header-line ((t (:background "gray10" :inherit (fixed-pitch)))))
     ...
     (linum ((t (:foreground "Green" :inherit (fringe)))))

     (font-lock-builtin-face           ((t (:foreground "LightSteelBlue"))))
     (font-lock-comment-delimiter-face ((t (:foreground "Tan3"))))
     (font-lock-comment-face           ((t (:foreground "Tan1"))))
     (font-lock-constant-face          ((t (:foreground "Aquamarine"))))
     (font-lock-doc-face               ((t (:foreground "LightSalmon" :background "Gray10"))))
     (font-lock-doc-string-face        ((t (:foreground "LightSalmon" :background "Gray10"))))
     (font-lock-function-name-face     ((t (:foreground "LightSkyBlue" :inherit bold))))
     (font-lock-keyword-face           ((t (:foreground "Cyan"))))
     (font-lock-preprocessor-face      ((t (:foreground "Aquamarine"))))
     (font-lock-reference-face         ((t (:foreground "LightSteelBlue"))))
     (font-lock-string-face            ((t (:foreground "LightSalmon"))))
     (font-lock-type-face              ((t (:foreground "PaleGreen" :inherit bold))))
     ...
     (widget-field ((t (:background "gray10" :box t))))
     (widget-inactive ((t (:foreground "light gray"))))
     (widget-single-line-field ((t (:background "gray10" :box t))))

     (toolbar ((t (:background "DodgerBlue2" :foreground "white"
                   :box (:line-width 1 :color "DodgerBlue1" :style released-button)))))
     (custom-button ((t (:background "DodgerBlue4" :foreground "white"
                         :box (:line-width 1 :color "DodgerBlue4" :style released-button)))))
     (custom-button-mouse ((t (:background "DodgerBlue3" :inherit custom-button))))
     (custom-button-pressed ((t (:background "DodgerBlue4" :foreground "White"
                                 :box (:line-width 1 :color "DodgerBlue4" :style pressed-button)))))

     (dired-directory ((t (:foreground "LightSkyBlue" :inherit bold))))
     ...
     (diff-added ((t (:foreground "Green1"))))
     ...
     (diff-header ((t (:foreground "DodgerBlue2"))))
...
(defun hcz-set-cursor-color-according-to-mode ()
  ...
  ;; needed:
  (let ((color
         (if buffer-read-only negval/*cursor-ro-color*
